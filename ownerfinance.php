...
if(isset($_POST['update_report'])){
    ...
    $update_p_cost = $_POST['update_p_cost'];
    $update_p_report = $_POST['update_p_report'];
    $update_staff_id = $_POST['update_staff_id'];

    $update_query = $conn->prepare("UPDATE `finance` SET date = ?, sales = ?, cost = ?, food_report = ?, staff_id = ? WHERE `date` = ?");
    $update_query->execute([$update_p_sales, $update_p_sales, $update_p_report, $update_staff_id]);
...
<body>
    ...
    <div class="container">
        ...
        <div class="chart" style="margin-left: 250px; margin-top: 50px;">
            <div class="title">
        ...
        <div class="box-report" style="margin-top: 10rem;">
            <form action="" method="post">
                <div class="reportBox">
                    ...
                    <h3>Enter today cost amount: 
                    <input type="number" id="sales" name="cost"  min="0" step="0.01"  placeholder="RM"required></h3>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $report_id['cost']; ?></td>
                        <td><?php echo $report_id['food_report']; ?></td>
                        <td>
                            <a href="ownerfinance.php?edit=<?php echo $report_id['date']; ?>" class="option-btn">
        ...
        <div class="display">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <label for="sales" style="font-size: 18px;">Sales</label>
                <input type="number" min="0" step="0.01"  class="box" required name="update_p_sales" value="<?php echo $fetch_edit['sales']; ?>">
                <label for="sales" style="font-size: 18px;">Cost</label>
                <input type="number" min="0" step="0.01"  class="box" required name="update_p_cost" value="<?php echo $fetch_edit['cost']; ?>">
                <label for="sales" style="font-size: 18px;">Report</label>
                <input type="text"class="box" required name="update_p_report" value="<?php echo $fetch_edit['food_report']; ?>">
                <label for="sales" style="font-size: 18px;">Choose your Name</label>
                ...
                <input type="submit" value="Update report" name="update_report" class="option-btn">
